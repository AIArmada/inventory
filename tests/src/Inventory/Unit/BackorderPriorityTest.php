...
test('BackorderPriority enum has correct cases', function () {
...
test('BackorderPriority label returns correct labels', function () {
...
test('BackorderPriority color returns correct colors', function () {
...
test('BackorderPriority sortOrder returns correct order', function () {
...
test('BackorderPriority isElevated works correctly', function () {
