...
test('DemandPeriodType enum has correct cases', function () {
...
test('DemandPeriodType label returns correct labels', function () {
...
test('DemandPeriodType daysPerPeriod returns correct days', function () {
