...
test('ReorderUrgency enum has correct cases', function () {
...
test('ReorderUrgency fromDaysUntilStockout calculates correctly', function () {
...
test('ReorderUrgency label returns correct labels', function () {
...
test('ReorderUrgency color returns correct colors', function () {
...
test('ReorderUrgency sortOrder returns correct order', function () {
