...
describe('CodeManipulator', function () {
    it('can be instantiated with a file path', function () {
    ...
    it('adds use statement', function () {
    ...
    it('does not duplicate use statement', function () {
    ...
    it('adds trait to class', function () {
    ...
    it('does not duplicate trait', function () {
    ...
    it('adds new property if not exists', function () {
    ...
    it('adds method to class', function () {
    ...
    it('does not duplicate method', function () {
    ...
    it('adds static method', function () {
    ...
    it('appends to array property', function () {
    ...
    it('saves changes to file', function () {
    ...
    it('returns false when no changes to save', function () {
    ...
    it('checks if class contains trait', function () {
    ...
    it('checks if class contains method', function () {
    ...
    it('checks if file contains use statement', function () {
    ...
    it('converts values to string representation', function () {
    ...
    it('converts array values to string representation', function () {
    ...
    it('handles non-associative arrays', function () {
