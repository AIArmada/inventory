...
> **Archived historical audit:** this report documents a December 2025 audit and fix cycle. Use the active package docs and current tests as the source of truth for present behavior.
